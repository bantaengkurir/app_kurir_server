...
const { login, loginWeb, register, verifyEmail, verifyDevice, checkAuth, logoutUser, logoutUserWeb, resendEmail, refreshToken } = require("../controllers/auth.controller");
